  ...
  <div class="plaque-email">
    <div class="plaque-email-inner">
         <div class="embedCode" style="margin-top:150px;">
          ...
          <TEXTAREA id='holdtext' style="margin:auto;color:#CD0000;background:#CDCDCD;font-size:12px;width:370px;height:120px;"><iframe src="http://player.vimeo.com/video/53978551?title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;color=ffffff" width="500" height="281" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe> <p>Royale Presents: <a href="https://weareroyale.com/thebellringer/"> The Bell Ringer Royale</a> .</p>
          </TEXTAREA>
